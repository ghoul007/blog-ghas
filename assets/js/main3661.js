    ...
    'use strict';
		...
		$(".newsletter-form").validator().on("submit", function (event) {
			...
			// handle the invalid form...
                ...
                if(language =='ar'){
                    submitMSGSub(false, "يرجى إدخال رقمك بشكل صحيح.");
                
                }
                else{
                    submitMSGSub(false, "Veuillez saisir votre numéro correctement.");
                ...
                $.ajax({
                    type: "POST",
                    url: "https://api.soskhedma.com/CreateCalling",
                    data: "phone=" + phone +"&status=0",
		...
		function formSuccessSub(){
            ...
            var  language = localStorage.getItem('language');
            if(language =='ar'){
                submitMSGSub(true, "شكرا");
            
            }
            else{
                submitMSGSub(true, "Merci");
            
            }	
			setTimeout(function() {
                if(language =='ar'){

                $("#sendsub").removeClass('colorbtnsend').text("انضم");
                }
                else{

               
                $("#sendsub").removeClass('colorbtnsend').text("Joindre");
            }
			}, 4000)
		}
		function formErrorSub(){
			$("#sendsub").addClass("animated shake");
			setTimeout(function() {
				$("#sendsub").removeClass("animated shake");
			}, 1000)
		}
		function submitMSGSub(valid, msg){
			...
			if(valid){
				var msgClasses = "colorbtnsend";
			} else {
				var msgClasses = "colorbtnsend";
			}
			$("#sendsub").removeClass().addClass(msgClasses).text(msg);
		}
		// AJAX MailChimp
        ...
        if(document.getElementById("particles-js")) particlesJS("particles-js", {
            ...
            , "interactivity": {
                ...
                , "modes": {
                    ...
                    , "bubble": {
                        "distance": 400, "size": 400, "duration": 2, "opacity": 8, "speed": 3
                    }
                    , "repulse": {
                        "distance": 200
                    }
